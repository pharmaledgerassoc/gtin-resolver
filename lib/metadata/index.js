...
function getMetadata(server){
    ...
    async function getDSUMetadataHandler(request, response) {
        ...
        try {
            ...
            //AFTER UNDERSTANDIG HOW TO UPDATE THE CACHE ADD FIXED URL LOGIC
            ...
            //base return not working properly
    ...
    server.get("/metadata/:domain", getDSUMetadataHandler);
    server.get("/metadata/:domain/:subdomain", function(req, res){
