  ...
  async function getLeafletHandler(request, response) {
    ...
    try {
      ...
      try{
        ...
        if(batchExists){
          let languages = await $$.promisify(leafletXmlService.getAvailableLanguagesFromPath)(batchGtinSSI, leafletXmlService.getBatchPathToXmlType());
