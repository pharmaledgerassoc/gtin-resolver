  ...
  async function getLeafletHandler(request, response) {
    ...
    try {
      ...
      try{
        ...
        if(batchExists){
          let batchLanguages = await $$.promisify(leafletXmlService.getAvailableLanguagesFromPath, leafletXmlService)(batchGtinSSI, leafletXmlService.getBatchPathToXmlType());
          ...
          let productLanguages = await $$.promisify(leafletXmlService.getAvailableLanguagesFromPath, leafletXmlService)(prodGTINSSI, leafletXmlService.getBatchPathToXmlType());
