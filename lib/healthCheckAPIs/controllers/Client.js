...
function Client(){
    ...
    this.checkBricking = async (action,callback)=>{
    ...
    this.checkDatabases = async (action,callback)=>{
    ...
    this.checkProducts = async (action,callback)=>{
    ...
    this.checkBatches = async (action,callback)=>{
