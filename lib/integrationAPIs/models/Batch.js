...
function Batch(enclave, domain, subdomain, gtin, batchNumber, version) {
    ...
    instance.persist = async () => {
        ...
        await $$.promisify(require("./../../utils.js").activateGtinOwnerFixedUrl)(undefined, domain, subdomain, gtin);
        await $$.promisify(require("./../../utils.js").activateLeafletFixedUrl)(undefined, subdomain, subdomain, gtin);
    }
