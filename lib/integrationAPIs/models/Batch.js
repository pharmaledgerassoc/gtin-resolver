...
function Batch(enclave, domain, subdomain, gtin, batchNumber, version) {
    ...
    instance.persist = async (auditContext) => {
        ...
        await $$.promisify(require("../../mappings/utils").activateGtinOwnerFixedUrl)(undefined, domain, gtin);
        await $$.promisify(require("../../mappings/utils").activateLeafletFixedUrl)(undefined, domain, gtin);
        return diffs;
    }
