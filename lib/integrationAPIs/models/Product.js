...
function Product(enclave, domain, subdomain, gtin, version) {
    ...
    instance.loadMetadata = async () => {
        ...
        instance.genericNameProduct = instance.genericNameProduct || "";
        instance.marketingAuthorizationNumber = instance.marketingAuthorizationNumber || "";
        instance.dateOfFirstAuthorization = instance.dateOfFirstAuthorization || "";
    }
    return instance;
}
