...
function ModelBase(enclave) {
    ...
    this.getMutableSeedSSI = async function () {
        ...
        let pathKeySSI = await $$.promisify(enclave.createPathKeySSI)($$.SYSTEM_IDENTIFIER, domain, path);
    ...
    this.ensureDSUStructure = async function () {
        ...
        await $$.promisify(immutableDSU.mount)(this.getMutableMountingPoint(), sreadSSI);
