...
function ModelBase(enclave, domain, subdomain, gtin) {
    ...
    this.recover = async () => {
        let seedSSI = await this.getPathKeySSI();
        ...
        let recoverDSU = async (ssi, recoveryFnc) => {
            return new Promise(async (resolve, reject) => {
                ...
                let dsu;
                try {
                    dsu = await $$.promisify(enclave.loadDSURecoveryMode)(ssi, recoverFnc);
                } catch (err) {
                    reject(err);
                    return;
                }
        ...
        return new Promise(async (resolve, reject) => {
            try {
                ...
                let recoveredMutableDSU = await recoverDSU(sreadSSI, recoveryMutableDSU);
            } catch (err) {
                return reject(err);
            }
            resolve(nextVersion);
