...
module.exports = function (server) {
    ...
    server.get("/integration/:domain/:subdomain/listProductsLangs/:gtin", async (req, res) => {
        const {gtin, domain, subdomain} = req.params;
        let languages;
        try {
    ...
    server.get("/integration/:domain/:subdomain/listBatchesLangs/:gtin/:batchNumber", async (req, res) => {
        const {gtin, domain, subdomain, batchNumber} = req.params;
        let languages;
        try {
