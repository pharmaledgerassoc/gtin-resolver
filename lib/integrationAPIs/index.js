...
module.exports = function (server) {
    ...
    server.get("/integration/:domain/:subdomain/product/:gtin", async function (req, res) {
        ...
        try {
            await req.productController.getProduct(domain, subdomain, gtin, res);
        } catch (err) {
            res.send(500);
            return;
        }
    ...
    server.put("/integration/:domain/:subdomain/image/:gtin", async function (req, res) {
        const {gtin, domain, subdomain} = req.params;
    ...
    server.put("/integration/:domain/:subdomain/batch/:gtin/:batchNumber", async function (req, res) {
        ...
        try {
            await req.batchController.addBatch(domain, subdomain, batchNumber, gtin, batchMessage, res);
        } catch (err) {
            res.send(500);
            return;
        }
    ...
    server.post("/integration/:domain/:subdomain/batch/:gtin/:batchNumber", async function (req, res) {
        ...
        try {
            await req.batchController.updateBatch(domain, subdomain, batchNumber, gtin, batchMessage, res);
        } catch (err) {
            res.send(500);
            return;
        }
    ...
    server.get("/integration/:domain/:subdomain/batch/:gtin/:batchNumber", async function (req, res) {
        ...
        try {
            await req.batchController.getBatch(domain, subdomain, gtin, res);
        } catch (err) {
            res.send(500);
            return;
        }
    ...
    server.put("/integration/:domain/:subdomain/epi/:gtin", leafletHandler);
    ...
    server.put("/integration/:domain/:subdomain/epi/:gtin/:batchNumber", leafletHandler);
    ...
    server.post("/integration/:domain/:subdomain/epi/:gtin", leafletHandler);
    ...
    server.post("/integration/:domain/:subdomain/epi/:gtin/:batchNumber", leafletHandler);
    ...
    async function deleteLeafletHandler(req, res) {
        ...
        try {
            await req.leafletController.deleteEPI(domain, subdomain, gtin, batchNumber, leafletMessage, res);
        } catch (err) {
            res.send(500);
            return;
        }
    ...
    server.delete("/integration/:domain/:subdomain/epi/:gtin", deleteLeafletHandler);
    ...
    server.delete("/integration/:domain/:subdomain/epi/:gtin/:batchNumber", deleteLeafletHandler);
