...
module.exports = function (server) {
    ...
    async function productEpiHandler(req, res) {
        ...
        try {
            await req.leafletController.addEPI(domain, subdomain, gtin, null, leafletMessage, req, res);
        } catch (err) {
            res.send(500);
            return;
        }
    ...
    async function batchEpiHandler(req, res) {
        ...
        try {
            await req.leafletController.addEPI(domain, subdomain, gtin, batchNumber, leafletMessage, req, res);
        } catch (err) {
            res.send(500);
            return;
        }
    ...
    async function getEpiHandler(req, res) {
        ...
        let EPI;
        try {
            EPI = await req.leafletController.getEPI(domain, subdomain, gtin, batchNumber, language, type, req, res);
        } catch (err) {
            return res.send(500);
        }
        if (!EPI) {
    ...
    async function deleteProductEpiHandler(req, res) {
        ...
        try {
            await req.leafletController.deleteProductEPI(domain, subdomain, gtin, leafletMessage, req, res);
        } catch (err) {
            res.send(500);
            return;
        }
    ...
    async function deleteBatchEpiHandler(req, res) {
        ...
        try {
            await req.leafletController.deleteBatchEPI(domain, subdomain, gtin, batchNumber, leafletMessage, req, res);
        } catch (err) {
            res.send(500);
            return;
        }
