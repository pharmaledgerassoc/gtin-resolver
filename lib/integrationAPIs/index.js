...
module.exports = function (server) {
    ...
    async function productEpiHandler(req, res) {
        ...
        try {
            await req.leafletController.addProductEPI(domain, subdomain, gtin, leafletMessage, res);
        } catch (err) {
            res.send(500);
            return;
        }
    ...
    async function batchEpiHandler(req, res) {
        ...
        try {
            await req.leafletController.addBatchEPI(domain, subdomain, gtin, batchNumber, leafletMessage, res);
        } catch (err) {
            res.send(500);
            return;
        }
