function LeafletController(enclave, version) {
    ...
    this.addEPI = async function (domain, subdomain, leafletMessage, res) {
        try {
        ...
        try {
            ...
            try {
                await targetObject.addEPI(domain, subdomain, leafletMessage);
    ...
    this.deleteEPI = async function (domain, subdomain, batchId, gtin, leafletMessage, res) {
        try {
