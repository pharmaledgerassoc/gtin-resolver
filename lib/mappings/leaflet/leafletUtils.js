...
module.exports = {
    ...
    getHostDSU: async function(message){
        ...
        this.mappingLogService = require("../../utils/logsUtils").createInstance(this.storageService);
        ...
        try {
            ...
            await this.mappingLogService.logFailedMapping(message, "lookup", dsuMapping.missingDSUMessage);
