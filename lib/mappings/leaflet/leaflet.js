...
async function processLeafletMessage(message) {
  ...
  try {
    ...
    try{
      await $$.promisify(require("./../utils.js").registerGtinOwnerFixedUrlByDomain)(this.options.holderInfo.domain, gtin);
    ...
    require("./../utils.js").activateLeafletFixedUrl(constHostDSU, gtin, basicCb);
  } catch (e) {
