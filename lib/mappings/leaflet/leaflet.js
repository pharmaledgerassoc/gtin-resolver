...
async function processLeafletMessage(message) {
  ...
  try {
    ...
    try{
      await $$.promisify(require("./../utils.js").registerGtinOwnerFixedUrlByDomain)(anchoringDomain, gtin);
      await $$.promisify(require("./../utils.js").registerLeafletFixedUrlByDomain)(...args);
      if(message.batchCode){
        ...
        await $$.promisify(require("./../utils.js").registerLeafletFixedUrlByDomain)(...newArgs);
      }
      await $$.promisify(require("./../utils.js").deactivateLeafletFixedUrl)(hostDSU, brickingDomain, gtin);
    }catch(err){
    ...
    require("./../utils.js").activateGtinOwnerFixedUrl(hostDSU, anchoringDomain, gtin, basicCb);

    //triggering the creation of fixedUrls for the leaflet
    require("./../utils.js").activateLeafletFixedUrl(hostDSU, brickingDomain, gtin, basicCb);
  } catch (e) {
