...
*  */
  ...
  let originalCommit = batchDSU.commitBatch;
  batchDSU.commitBatch = (onConflict, callback) => {
    if (typeof callback === 'undefined') {
      callback = onConflict;
      onConflict = undefined;
    }
    originalCommit.call(batchDSU, onConflict, async (err) => {
      if (!err) {
