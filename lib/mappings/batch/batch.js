...
async function processBatchMessage(message) {
  ...
  *  */
    ...
    //let productMetadata = await productUtils.getProductMetadata.call(this, message, productCode);
    let {productDSU} = await productUtils.getProductDSU.call(this, message, productCode);
    // if (!this.batch.product) {
    //     let ssi = await productDSU.getKeySSIAsString("sread");
    //     this.batch.product = ssi;
    // }
