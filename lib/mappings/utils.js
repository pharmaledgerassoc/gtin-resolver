...
function createURLQuery(type, domain, gtin, batchNumber, lang, leaflet_type, epiMarket){
  ...
  switch (type) {
    ...
    case "gtinOwner":
      ...
      break;
    case "metadata":
      text =  buildLeafletMetadataURL(domain, gtin, batchNumber);
      break;
    default:
...
function registerLeafletFixedUrlByDomain(domain, subdomain,  leaflet_type, gtin, language, batchNumber, market, callback){
  if (!callback) {  
    callback = market;  
    market = undefined;
  }
