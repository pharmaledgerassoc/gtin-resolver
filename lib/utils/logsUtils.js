...
async function createOrUpdateRecord(storageService, dbTable, pk, data) {
  ...
  if (dbRecord) {
    ...
    await $$.promisify(storageService.addIndex.bind(storageService))(dbTable, "__timestamp");
    await $$.promisify(storageService.insertRecord.bind(storageService))(dbTable, pk, data);
  }
}
