module.exports = {
  ...
  DISABLED_FEATURES_MAP: {
    ...
    "02": {
      modelProperties: ["showEPIOnBatchExpired", "expiredDateCheck"],
      description: "Show leaflet if batch expired"
    },
    "03": {
      modelProperties: ["showEPIOnUnknownBatchNumber"],
      description: "Show leaflet if batch unknown"
    },
    "04": {
    ...
    "07": {
      modelProperties: ["showEPIOnSNRecalled", "hasAcdcAuthFeature", "authFeatureFieldModel", "serialCheck"],
      description: "Anti-counterfeiting functions"
    },
    "08": {
      modelProperties: ["showEPIOnBatchRecalled", "recalled"],
