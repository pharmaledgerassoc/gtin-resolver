...
const gtinResolverUtils = require("../lib/utils/utils")
const dc = require("gtin-resolver/tests/double-check.json");
const {assert} = dc;
const http = opendsu.loadApi("http");
const doPut = $$.promisify(http.doPut);
const utils = require("../utils");
const gtinResolver = require("gtin-resolver/index");
const domain = "epi";
const subdomain = "default";
const resolver = require("opendsu").loadApi("resolver");
/*
* apihub url and header token should be updated for each specific installation
* */
