...
let initialProductMessage = buildProductMessage();
let updateProductMessage = buildProductMessage();
...
assert.callback("Recovery Mode for Product based messages", productTest, 1000000);
